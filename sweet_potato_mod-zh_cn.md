...
女士们、先生们：  
**圣诞节快乐！**  
在欢度这个神圣又特殊的节日之际，我们精心准备了烤地瓜模组圣诞节2020特供版。
### 新的内容
#### 圣诞树
圣诞树是在该特供版中特别添加的一种树。当它长成后，它将拥有云杉的树干和独特的圣诞树叶。其中的一些树叶会挂礼物。  
#### 许愿碗
许愿碗可以通过一个地瓜粉和一个碗来合成。它可以用来对村民进行Christmatato。  
许愿碗十分具有纪念意义，请务必妥善保留每一个你合成的许愿碗。  
#### 圣诞袜
当你装载该特供版并打开你游玩了很久的存档，你会发现你所有的地瓜都换上了新衣，地瓜皮变成了圣诞袜。  
圣诞袜有两个变种，其中一种可以装礼物。拿出礼物很简单，你只需要按下使用键即可把礼物装进你的背包。  
你可以通过Christmatato或破坏圣诞树叶来获得装礼物的圣诞袜。  
#### 进度
我们添加了一些进度，它们可以帮助你解锁故事的主线。加油，祝君好运！

![2020-10-28_19.30.37.png](https://i.loli.net/2020/11/01/6eZRi2UvuHOKwsg.png)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------
### 温馨提示：本模组目前仅支持1.16-1.16.7 (快照），因为整个模组的农业与魔法风格与下界更新的黑石风格密切相关。
...
### 注意事项
+ 目前该模组仅支持1.16-1.17 (快照)，之前版本的玩家很抱歉，我们暂时不支持你们的版本。(1.13.2以下的玩家，十分抱歉，本模组的作者不开发Forge/Rift。如果有懂Forge/Rift的朋友愿意改写，可以联系我们)
